...
class CourseController extends Controller
{
    ...
    public function course_details(Request $request)
    {
        ...
        "country_master.CountryName","course_types.course_types","qualification_master.Qualification","course_category.course_category","institute.institute_logo","institute.institute_banner","course.created_by")
                                ...
                                <div class="education_block_list_layout style-2">
                                    <div class="list_layout_ecucation_caption">
                                        <div class="cb-college-name-section">
                                            ...
                                            <div class="list_layout_ecucation_caption">
                                                <div class="education_block_body">
                                                    <h4 class="bl-title college-name"><a href="'.url('college-details', $list->institute_id) .'">'.$list->company_name.'</a></h4>
