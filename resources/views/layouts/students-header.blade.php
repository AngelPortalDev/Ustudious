...
<html lang="en">
	...
	<?php    $LoginID = session()->get('student_id') ?>
    <body class="red-skin">
					...
					<nav id="navigation" class="navigation navigation-landscape">
						...
						<div class="nav-menus-wrapper" style="transition-property: none;">
							...
							{{-- <ul class="nav-menu">
								...
								@if($LoginID)
								<li><a href="{{route('institute-post-course',['add',$LoginID])}}">Post Course </a> </li>
								@endif
								<!-- <li><a href="#">Courses -->
