                                                ...
                                                <div class="row g-2">
                                                    <form class="basicCourseFormAdd">
                                                        <input type='hidden' class="course_id" name='course_id'
                                                            value="{{  base64_encode($CourseData->id) }}">

                                                        <div class="col-12">
                                                            <label for="course_name" class="form-label">Course Name <span
                                                                    class="text-danger">*</span> </label>
                                                            <input type="text" class="form-control" id="course_name"
                                                                placeholder="Course Name" name="course_name" value="{{$CourseData->course_name}}">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input type="text" class="form-control" id="subheading"
                                                                placeholder="Subheading" name="subheading" value="{{$CourseData->course_name}}">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select class="form-control" name="course_types"
                                                                ...
                                                                @foreach ($courseTypeData as $data)
                                                                    <option value="{{ $data->course_types_id }}" @if($data->course_types_id == $CourseData->course_types) selected @endif>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select class="form-control" name="mode_of_study"
                                                                ...
                                                                <option value="part_time" @if($CourseData->mode_of_study ==  "part_time") selected @endif>Part Time</option>
                                                                <option value="full_time" @if($CourseData->mode_of_study == "full_time") selected @endif>Full Time</option>
                                                                <option value="distance" @if($CourseData->mode_of_study == "distance") selected @endif>Distance </option>
                                                            </select>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select class="form-control" name="course_category"
                                                                ...
                                                                @foreach ($categoryData as $data)
                                                                    <option value="{{ $data->id }}" @if($data->id == $CourseData->course_category) selected @endif>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input type="text" class="form-control" id="course_fees"
                                                                placeholder="Course Final Price" name="course_fees" value="{{$CourseData->course_fees}}">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                name="administrative_cost" value="{{$CourseData->administrative_cost}}">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <input type="text" class="form-control" id="total_cost"
                                                                placeholder="Scholarship " name="total_cost" value="{{$CourseData->total_cost}}">
                                                        </div>
                                                    ...
                                                    <form class="basicCourseOtherForm">
                                                        ...
                                                        <div class="col-12 mt-2">
                                                            ...
                                                            <div id="course_overview" name="course_overview"
                                                                ...
                                                                {!! html_entity_decode($CourseData->course_overview) !!}
                                                        ...
                                                        <div class="col-12 mt-2">
                                                            ...
                                                            <div id="course_curriculum" name="course_curriculum"
                                                                class="form-control w-100" style="height: 200px" required>
                                                                {!! html_entity_decode($CourseData->course_curriculum) !!}
                                                            </div>
                                                        ...
                                                        <div class="col-12 mt-2">
                                                            ...
                                                            <div id="course_opportunities" name="course_opportunities"
                                                                class="form-control w-100" style="height: 200px" required>
                                                                {!! html_entity_decode($CourseData->course_opportunities) !!}
                                                            </div>
                                                        ...
                                                        <div class="col-12 mt-2">
                                                            ...
                                                            <div id="application_procedure" name="application_procedure"
                                                                class="form-control w-100" style="height: 200px" required>
                                                                {!! html_entity_decode($CourseData->application_procedure) !!}
                                                            </div>
                                                ...
                                                <form class="CourseMediaForm">
                                                    <div>
                                                        ...
                                                        <div class="d-block">
                                                            ...
                                                            @if($CourseData->thumbnail_img)
                                                             <img class="image-preview img-fluid mb-4" src="{{Storage::url('course/thumbnailsContent/'.$CourseData->thumbnail_img)}}"
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="file" class="form-control course_trailor" accept=".mp4"
                                                                id="course_trailor" name="course_trailor" value="{{$CourseData->course_trailor}}">
                                                            <label class="input-group-text"
                                                        ...
                                                        <div class="d-block mb-4">
                                                            ...
                                                            @if (isset($CourseData->course_trailor) && !empty($CourseData->course_trailor))
                                                            @php
                                                            $videUrl=  $CourseData->course_trailor;
                                                            @endphp
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="file" class="form-control trailor_thumbnail" accept=".jpeg,.png,.jpg,.svg" name="trailor_thumbnail"
                                                        ...
                                                        <div class="d-block">
                                                            @if($CourseData->thumbnail_img)
                                                             <img class="trailor_thumbnail_preview img-fluid mb-4" src="{{Storage::url('course/thumbnailsContent/'.$CourseData->trailor_thumbnail)}}"
                                                            style="width: 400px;height: 230px;">
                                                            @else
