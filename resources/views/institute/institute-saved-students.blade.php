...
$ASSET_PATH = env('ASSET_URL').'/';
  ...
  $InstituteData = DB::table('institute')->select('institute.institute_banner','institute.institute_logo','institute.company_name','country_master.CountryName','institute.institute_id')
	...
	->where('institutes_viewed_student.institute_id', $LoginID)
					...
					<div class="d-navigation">
						<ul id="side-menu">
							...
							<li><a href="{{route('institute-posted-course')}}"><i class="ti-heart"></i>Posted
									Course</a></li>
							<li class="active"><a href="{{route('institute-saved-students')}}"><i class="ti-heart"></i>Saved
									Students</a></li>
					...
					<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
						<div class="education_block_list_layout style-2">
							...
							<div class="list_layout_ecucation_caption">
								...
								@if (session()->get('institute_id'))
                                @php $exists = DB::table('institutes_viewed_student')->where('student_id',$list->StudentID)->where('institute_id',session()->get('institute_id'))->where('is_saved','Yes')->count();@endphp
								...
								@else
                                <div class="save-btn">
                                    <a class="instlogincheck"><i class="fa fa-bookmark" aria-hidden="true"></i></a>
